...
class SaladDetails extends StatefulWidget {
  String? Id;
  SaladDetails({Key? key, this.Id}) : super(key: key);

  @override
  State<SaladDetails> createState() => _SaladDetailsState();
}

class _SaladDetailsState extends State<SaladDetails> {
  var Counter = 0;
  ...
  Future<String> getProductDetails() async {
    var snapShot = await FirebaseFirestore.instance.collection("Products").doc("salad").collection("Salad").doc(widget.Id).get();
