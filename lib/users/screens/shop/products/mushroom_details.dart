...
class MushroomDetails extends StatefulWidget {
  String? Id;
  MushroomDetails({Key? key, this.Id}) : super(key: key);

  @override
  State<MushroomDetails> createState() => _MushroomDetailsState();
}

class _MushroomDetailsState extends State<MushroomDetails> {
   var Counter = 0;
  ...
  Future<String> getProductDetails() async {
    var snapShot = await FirebaseFirestore.instance.collection("Products").doc("mushroom").collection("Mushroom").doc(widget.Id).get();
