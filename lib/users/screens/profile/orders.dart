...
var TextColor = Colors.white;
  Widget GetOrders() {
    return StreamBuilder(
        stream: FirebaseFirestore.instance.collection('Users').doc("products").collection("Products").where("UserId", isEqualTo: FirebaseAuth.instance.currentUser!.uid).snapshots(),
