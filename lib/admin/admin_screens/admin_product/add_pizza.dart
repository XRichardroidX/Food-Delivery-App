...
class _AddPizzaState extends State<AddPizza> {
  ...
  function(String ProductName, Uint8List file, String Price, String ProductDescription) async {
    ...
    await Database(FirebaseFirestore.instance, context).AddPizzaToCloudFireStore(ImageUrl, ProductName, Price, ProductDescription);
          ...
          children: [
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  labelText: "Pizza Price:",
                  hintText: "Pizza Price",
                  border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(0.0)
                  ),
                  focusedBorder: OutlineInputBorder(
            ...
            Container(
              ...
              child: TextField(
                ...
                cursorColor: Colors.green,
                decoration: InputDecoration(
                  labelText: "Pizza Description:",
                  hintText: "Pizza Description",
                  border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(0.0)
                  ),
                  focusedBorder: OutlineInputBorder(
